...
35. Підтягування змін  
    ...
    Oтримання оновлень через git fetch
...
37. Додавання гілки відстеження  
    ...
    Cтворення локальної гілки, що відстежує віддалену
